...
BOT_TOKEN = environ.get('BOT_TOKEN', "8575810354:AAFiWS8jscWjaZ9yo3Y6MAebq-FEfIicB6E")    # Bot token from @BotFather
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003377902801').split()]  # Channel id for auto indexing (make sure bot is admin)
